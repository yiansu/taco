...
// taco "A(i, j) = B(i, j, k) * c(k)" -f=A:dd -f=B:dss -f=c:d -write-compute=compute2.hpp
...
void test_correctness(
  ...
  TTV_baseline(A1_dimension, A2_dimension, A_vals_ref, B1_dimension, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
...
void HEARTBEAT_loop2(
  ...
  for (uint64_t jB = startIter; jB < maxIter; jB++) {
    ...
    uint64_t jA = i * A2_dimension + j;
    double tkA_val = 0.0;
    tkA_val += HEARTBEAT_loop3(B3_pos[jB], B3_pos[(jB + 1)], B3_crd, B_vals, c_vals);
    A_vals[jA] = tkA_val;
  }
}
...
void HEARTBEAT_loop1(
  ...
  for (uint64_t i = 0; i < maxIter; i++) {
    HEARTBEAT_loop2(B2_pos[i], B2_pos[(i + 1)], A2_dimension, A_vals, B2_crd, B3_pos, B3_crd, B_vals, c_vals, i);
  }
}
...
void TTV_hbc(
  ...
  HEARTBEAT_loop1(B1_dimension, A2_dimension, A_vals, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
}
...
int compute(taco_tensor_t *A, taco_tensor_t *B, taco_tensor_t *c) {
  ...
  run_bench([&] {
    ...
    for (int i = 0; i < runs; i++) {
      ...
      TTV_baseline(A1_dimension, A2_dimension, A_vals, B1_dimension, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
#elif defined(USE_OPENMP)
      TTV_openmp(A1_dimension, A2_dimension, A_vals, B1_dimension, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
#elif defined(USE_HB_COMPILER)
      TTV_hbc(A1_dimension, A2_dimension, A_vals, B1_dimension, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
#endif
    }

#if defined(TEST_CORRECTNESS)
    test_correctness(A1_dimension, A2_dimension, A_vals, B1_dimension, B2_pos, B2_crd, B3_pos, B3_crd, B_vals, c_vals);
#endif
